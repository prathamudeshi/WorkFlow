...
<body>
    <div id="nav">
        <div id="nav-part1">
            <svg width="106" id="twogood" height="83" viewBox="0 0 106 83" fill="none"
            ...
            <svg width="62" id="twogood logo" height="63" viewBox="0 0 62 63" fill="none"
    ...
    <!-- <div id="form"> -->
        <div id="formin">
            <div id="form shadow-lg">
        <form method = "post">
            <div class="mb-3">
              <label style="font-weight:600;" for="exampleInputEmail1" class="form-label">Email address</label>
              <input style="border-width: 3.5px; border-color: black;  border-radius: 20px;"type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              <div id="emailHelp" style="font-weight: 600; font-size: 14px;" class="form-text">We'll never share your email with anyone else.</div>
            </div>
            <div class="mb-3">
              <label style="font-weight:600;" for="exampleInputPassword1" class="form-label">Password</label>
              <input style="border-width: 3.5px; border-color: black; border-radius: 20px;" type="password" class="form-control" id="exampleInputPassword1">
            </div>
            <div class="mb-3 form-check">
              <input style="border: 2.5px solid black; border-radius: 10px; " type="checkbox" class="form-check-input" id="exampleCheck1">
